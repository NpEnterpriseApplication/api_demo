...
class ProductDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<TopProductController>(
        ...
        return Scaffold(
          ...
          body: Obx(() {
            if(controller.isLoading.isFalse){
              var res = controller.productDetailsRes.value.data;
              return Padding(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return InkWell(
                                      ...
                                      child: SimilarPopularBrandWidget(
                                          index: index),
                                    );
                                  },
                                )),
                            ...
                            Flex(
                              ...
                              children: [
                                ...
                                Expanded(
                                    flex: 1,
                                    child:
                                    _buildIndicatorAndText("Strong space")),
                                Expanded(
                                    flex: 1,
                                ...
                                Expanded(
                                    flex: 1,
                                    child:
                                    _buildIndicatorAndText("Durability")),
                              ],
                            ),
                            sizedBoxHeight20,
                            Align(
